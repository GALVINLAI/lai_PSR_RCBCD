...
def main(p, sigma, repeat, lr_gd, lr_rcd):
    ...
    make_dir('exp_noise_new')
    make_dir(f'exp_noise_new/p_{p}')
    for exp_i in range(repeat):
        ...
        if os.path.exists(f'exp_noise_new/lr_{lr_gd}/p_{p}/sigma_{sigma}/exp_{exp_i}/data_dict.pkl'):
            continue
        ...
        make_dir(f'exp_noise_new/lr_{lr_gd}/p_{p}/sigma_{sigma}/exp_{exp_i}')
        data_dict = {
        ...
        dump(data_dict, f'exp_noise_new/lr_{lr_gd}/p_{p}/sigma_{sigma}/exp_{exp_i}/data_dict.pkl')
